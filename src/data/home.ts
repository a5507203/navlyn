...
export const homeWhatWeDo = {
  ...
  slides: [
    {
      image: assetPath('/media/home/overview/what-we-do-1.webp'),
      alt: '航链科技业务与团队展示',
      imagePosition: 'center center',
    },
    {
      image: assetPath('/media/home/overview/what-we-do-2.webp'),
      alt: '航链科技低空智能场景展示',
      imagePosition: 'center center',
    },
  ...
  cards: [
    {
      ...
      image: assetPath('/media/home/industries/agriculture.webp'),
      imageAlt: '农业场景航拍图',
      imagePosition: 'center center',
    },
    {
      ...
      image: assetPath('/media/home/industries/mining.webp'),
      imageAlt: '矿业作业场景图',
      imagePosition: 'center center',
    },
    {
      ...
      image: assetPath('/media/home/industries/energy.webp'),
      imageAlt: '能源基础设施场景图',
    ...
    },
    {
      ...
      image: assetPath('/media/home/industries/security.webp'),
      imageAlt: '安防与应急响应场景图',
      imagePosition: 'center center',
    },
    {
      ...
      image: assetPath('/media/home/industries/coastal.webp'),
      imageAlt: '海岸救援场景图',
      imagePosition: 'center center',
    },
    {
      ...
      image: assetPath('/media/home/industries/inspection.webp'),
      imageAlt: '巡检场景图',
      imagePosition: 'center center',
    },
...
export const homeCapabilities: HomeCapabilityItem[] = [
  {
    ...
    tags: ['意图理解', '自动规划', '全域治理'],
    icon: 'arc-engine',
    image: assetPath('/media/home/capabilities/arc-engine.webp'),
  ...
  },
  {
    ...
    icon: 'hardware',
    image: assetPath('/media/home/capabilities/arc-console.webp'),
  ...
  },
  {
    ...
    tags: ['多机协同', '主动安全', '权限治理'],
    icon: 'swarm',
    image: assetPath('/media/home/capabilities/swarm-security.webp'),
  ...
  },
  {
    ...
    tags: ['全球交付', '实地验证', '规模落地'],
    icon: 'delivery',
    image: assetPath('/media/home/capabilities/delivery.webp'),
...
export const homeHardwareMatrix = {
  ...
  software: {
    ...
    image: assetPath('/media/home/capabilities/arc-module.webp'),
  ...
  items: [
    {
      ...
      image: assetPath('/media/news/NANF2027-opq4339369331.webp'),
      alt: '航链科技发布会现场',
    ...
    },
    {
      ...
      meta: '2026.02 · 浙江电视台',
      source: '浙江电视台',
      image: assetPath('/media/news/NANF2041-opq4339388354.webp'),
      alt: '航链科技现场讲解',
    ...
    },
    {
      ...
      source: '中国经济新闻网',
      image: assetPath('/media/news/NANF2116-opq4339429072.webp'),
      alt: '航链科技专访现场',
    ...
    },
    {
      ...
      meta: '2026.01 · 行业峰会',
      source: '行业媒体联盟',
      image: assetPath('/media/news/DSC07068-opq4339381333.webp'),
      alt: '航链科技峰会展示',
    ...
    },
    {
      ...
      meta: '2026.01 · 国际合作',
      source: '国际合作媒体',
      image: assetPath('/media/news/DSC07230-opq4339422028.webp'),
      alt: '国际合作签约现场',
