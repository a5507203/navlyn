...
export const productHero = {
  ...
  video: assetPath('/media/products/commander/rescue.mp4'),
  poster: assetPath('/media/products/commander/commander-x1.webp'),
};
...
export const productDetails: ProductDetailItem[] = [
  ...
  },
  {
    ...
    image: assetPath('/media/products/scout-s1-front.webp'),
    imageAlt: 'Scout S1',
