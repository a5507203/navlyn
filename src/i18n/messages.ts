    ...
    contact: {
      ...
      inquiryForm: {
        ...
        organizationOptions: [
          ...
          { value: "partner", label: "经销商 / 合作伙伴" },
          { value: "research", label: "高校 / 研究机构" },
          { value: "other", label: "其他" },
        ],
        submitLabel: "通过邮件发送需求",
        submitNote: "点击后将打开您的邮件应用，信息不会自动发送。",
        mailSubject: "Navlyn 官网咨询",
      },
    },
    partners: {
  ...
  en: {
    ...
    contact: {
      ...
      inquiryForm: {
        ...
        submitNote: "This opens your email app. Nothing is sent automatically.",
        mailSubject: "Navlyn website inquiry",
      },
    },
    partners: {
